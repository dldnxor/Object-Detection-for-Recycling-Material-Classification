...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt_json", type=str, default="../dataset/val_split.json")
    parser.add_argument("--pred_csv", type=str, default="./val_universenet.csv")
    parser.add_argument(
        "--file_name",
        type=str,
        default="universe_mosaic_matrix.png",
    )
