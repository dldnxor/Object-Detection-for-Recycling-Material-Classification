...
# config file 들고오기
cfg = Config.fromfile(
    "./configs/universenet/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco.py"
)
...
submission.to_csv(os.path.join(cfg.work_dir, f"univnet_submission_{epoch}.csv"), index=None)
# submission.head()
